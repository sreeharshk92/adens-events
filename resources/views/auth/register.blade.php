<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        {{-- <div class="mt-4">
            ...
            <x-text-input id="gst_number" class="block mt-1 w-full" type="number" name="gst_number" :value="old('gst_number')" required autocomplete="username" />
    ...
    <x-textarea id="address" name="address" required class="block mt-1 w-full">{{ old('address') }}</x-textarea>
