                                            ...
                                            <div x-cloak x-show="editOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                                <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 mx-4">
                                                    ...
                                                    <form action="{{ route('menu-items.update', $item) }}" method="POST">
                                                        ...
                                                        <div class="space-y-4">
                                                            <div>
                                                                <label for="name-{{ $item->id }}" class="block text-sm font-medium text-gray-700">Menu Item Name</label>
                                                                <input type="text" name="name" id="name-{{ $item->id }}" required
                                                                       value="{{ $item->name }}"
                                                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                                            </div>

                                                            <div>
                                                                <label for="menu_category_id-{{ $item->id }}" class="block text-sm font-medium text-gray-700">Category</label>
                                                                <select name="menu_category_id" id="menu_category_id-{{ $item->id }}" required
                                                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                                                    <option value="">Select a category</option>
                                                                    @foreach($categories as $category)
                                                            ...
                                                            <div>
                                                                <label for="description-{{ $item->id }}" class="block text-sm font-medium text-gray-700">Description (Optional)</label>
                                        ...
                                        <div x-data="{ deleteOpen: false }" class="inline">
                                            ...
                                            <div x-cloak x-show="deleteOpen" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                                                <div class="bg-white rounded-lg shadow-lg w-96 p-6 mx-4">
                                                    ...
                                                    <p class="text-sm text-gray-600 mb-6">Are you sure you want to delete "{{ $item->name }}"?</p>
