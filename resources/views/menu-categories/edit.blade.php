            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8 border-t pt-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-3">Menu Items in this Category</h3>
                        <ul class="list-disc list-inside ml-4">
                            @foreach($menuCategory->menuItems as $item)
                            <li class="text-sm text-gray-600">{{ $item->name }}</li>
                            @endforeach
                        </ul>
                        <p class="text-sm text-gray-500 mt-2">
                            Note: You cannot delete this category until all menu items are removed or moved to another category.
                        </p>
                    </div>
                    @endif
                </div>
